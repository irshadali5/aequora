...
forbid_package "custom client + custom authority" "$neutral_tree" "rusqlite"
...
forbid_package "custom client + custom authority" "$neutral_tree" "aequora-store-sqlite"
...
forbid_package "Stoolap client + custom authority" "$client_tree" "rusqlite"
forbid_package "Stoolap client + custom authority" "$client_tree" "aequora-store-sqlite"

check_profile "SQLite client + custom authority" "sqlite,http-client"
sqlite_tree="$(tree_for "sqlite,http-client")"
require_package "SQLite client + custom authority" "$sqlite_tree" "rusqlite"
require_package "SQLite client + custom authority" "$sqlite_tree" "aequora-store-sqlite"
forbid_package "SQLite client + custom authority" "$sqlite_tree" "stoolap"
forbid_package "SQLite client + custom authority" "$sqlite_tree" "sqlx"
forbid_package "SQLite client + custom authority" "$sqlite_tree" "aequora-store-stoolap"
forbid_package "SQLite client + custom authority" "$sqlite_tree" "aequora-store-postgres"
...
forbid_package "custom client + PostgreSQL authority" "$authority_tree" "rusqlite"
forbid_package "custom client + PostgreSQL authority" "$authority_tree" "aequora-store-sqlite"
...
check_profile "SQLite client + PostgreSQL authority" "sqlite,http-client,postgres,axum"
sqlite_combined_tree="$(tree_for "sqlite,http-client,postgres,axum")"
require_package "SQLite client + PostgreSQL authority" "$sqlite_combined_tree" "rusqlite"
require_package "SQLite client + PostgreSQL authority" "$sqlite_combined_tree" "sqlx"
require_package "SQLite client + PostgreSQL authority" "$sqlite_combined_tree" "aequora-store-sqlite"
require_package "SQLite client + PostgreSQL authority" "$sqlite_combined_tree" "aequora-store-postgres"
forbid_package "SQLite client + PostgreSQL authority" "$sqlite_combined_tree" "stoolap"
forbid_package "SQLite client + PostgreSQL authority" "$sqlite_combined_tree" "aequora-store-stoolap"

echo "database-neutrality policy passed for neutral, Stoolap, SQLite, authority-only, and combined profiles"
